...
// Configuration word
// 24 bit config 1 0b<unimp>0000<unimp>0000<res>0<jtag off>0<code prot off>1<prog writes on>1<debug off>1<res>1<EMUD1>11<wdtoff>0<stdrd wdt>1<unimp>0<wdt pres 128 on (4ms)>1<wdt posc see table>****>*/
...
_CONFIG1(0b000000000011111101011010) /*4s wdt*/
...
void SystemPwrSave(unsigned long NapSetting)
{
	...
	asm("DISI #0x3FFF"); // Stop interrupts
	...
	{
		USB_BUS_SENSE_INT_ENABLE(); 		// Shared with button inter on change notifications
	}	 	
