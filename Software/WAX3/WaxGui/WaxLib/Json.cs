...
// Original from: http://techblog.procurios.nl/l/nl/library/download/14610
...
/*** SIMPLE EXAMPLE ***
    ...
    sourceData.Add("test", 123);
    string jsonData = JSON.Json.JsonEncode(sourceData);
    Console.WriteLine("JSON: " + jsonData);

    // Decode JSON data
    Hashtable data = (Hashtable)JSON.Json.JsonDecode(jsonData);
...
namespace WaxLib
{
    ...
    public static class Json
    {
        ...
        private static bool SerializeValue(object value, StringBuilder builder)
        {
            ...
            else if (value is Array)    // [dgj]
            {
                Array a = (Array)value;
                ArrayList arrayList = new ArrayList(a.GetLength(0));
                for (int i = 0; i < a.GetLength(0); i++) { arrayList.Add(a.GetValue(i)); }
