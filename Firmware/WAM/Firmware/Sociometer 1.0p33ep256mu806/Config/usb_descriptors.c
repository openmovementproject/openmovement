...
ROM struct{BYTE bLength;BYTE bDscType;WORD string[28];}sd002={
    ...
    {'W','A','M',' ','C','o','m','p','o','s','i','t','e',' ','D','e','v','i','c','e',' ','0' + (HARDWARE_VERSION >> 4),'.','0' + (HARDWARE_VERSION & 0x0f),' ',' '}
};
...
struct { BYTE bLength; BYTE bDscType; WORD string[11]; } sd003 =
{
    ...
    {'W','A','M','0' + (HARDWARE_VERSION >> 4),'0' + (HARDWARE_VERSION & 0x0f),'_',',',',',',',',',','}
}; //                                                                            14  16  18  20  22
#endif
...
const ROM InquiryResponse inq_resp =
{
    ...
    {'W','A','M',' ',' ',' ',' ',' '},                                  // T10 assigned Vendor identification
    {'W','A','M',' ','M','a','s','s',' ','S','t','o','r','a','g','e'},  // Product identification
...
#else
	#error "you have made a mistake, this descriptor file has been modded to add another descriptor"
#endif
}
