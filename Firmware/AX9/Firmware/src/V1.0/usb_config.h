...
/* FAST MSD SETTINGS */
#define USB_USE_ASYNC_MSD	// Without this, following behave normally: AsynMsdUcbDevice.c, USB_MSD_CDC.c

#ifdef USB_USE_ASYNC_MSD
#define MANAGING_OWN_MSD_BUFFER
#define USB_MSD_TASKS_TRIGGER()		{IFS0bits.IC2IF = 1;}
#define USB_MSD_TASKS_CLEAR()		{IFS0bits.IC2IF = 0;}
#define USB_MSD_TASKS_INT_ENABLE()	{\
									IPC1bits.IC2IP = 1;\
									IFS0bits.IC2IF = 0;\
									IEC0bits.IC2IE = 1;}
#define USB_MSD_TASKS_INT_DISABLE()	{IEC0bits.IC2IE = 0;}								
#define MsdInterrupt				_IC2Interrupt
#endif
