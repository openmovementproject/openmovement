...
ROM USB_DEVICE_DESCRIPTOR device_dsc=
{
    ...
    0x0000 | HARDWARE_VERSION_BCD,  // Device release number in BCD format
...
ROM struct{BYTE bLength;BYTE bDscType;WORD string[10];}sd002={
    ...
    {'A','X','9',' ','v','0' + (HARDWARE_VERSION_BCD >> 4),'.','0' + (HARDWARE_VERSION_BCD & 0x0f),' ',' '}
};
...
struct { BYTE bLength; BYTE bDscType; WORD string[13]; } sd003 =
{
    sizeof(sd003), USB_DESCRIPTOR_STRING,		// sizeof(sd003) = 24, USB_DESCRIPTOR_STRING = 0x03
    {'A','X','9',' ','v','0' + (HARDWARE_VERSION_BCD >> 4),'0' + (HARDWARE_VERSION_BCD & 0x0f),'_',',',',',',',',',','}
}; //                                                                            14  16  18  20  22
#endif
...
const ROM InquiryResponse inq_resp =
{
    ...
    {'A','X','9',' ',' ',' ',' ',' '},                                  // T10 assigned Vendor identification
    {'A','X','9',' ','M','a','s','s',' ','S','t','o','r','a','g','e'},  // Product identification
    {'0' + ((HARDWARE_VERSION_BCD >> 12) & 0x0f),'0' + ((HARDWARE_VERSION_BCD >> 8) & 0x0f),'0' + ((HARDWARE_VERSION_BCD >> 4) & 0x0f),'0' + (HARDWARE_VERSION_BCD & 0x0f)} // Product revision level
};
