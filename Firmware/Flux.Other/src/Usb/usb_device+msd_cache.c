 ...
 *******************************************************************/
	...
	#endif
//KL: Taking ownership of msd_buffer
#ifndef MANAGING_OWN_MSD_BUFFER
...
#endif
{
    ...
    if(USBSOFIF)
    {
        ...
        #endif
	//KL: Start of frame interrupt
	#ifdef USB_MSD_TASKS_TRIGGER
	USB_MSD_TASKS_TRIGGER();
	#endif
    }
...
//KL: MSD endpoint transaction interrupt
#ifdef USB_MSD_TASKS_TRIGGER
if(endpoint_number == MSD_DATA_IN_EP)
{
	USB_MSD_TASKS_TRIGGER();
}
#endif
